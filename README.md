...
* `analysis`: Scripts used to perform (1) trajectory and RNA velocity analysis using scFates and scVelo, (2) compositional analysis between conditions using DCATS and miloR, (3) differential gene expression testing using DEseq2, (4) Euclidean and energy distance testing using pertpy, (5) lineage coupling and clonal clustering analysis using coSpar, scLiTr and Monocle3.

* `plot`: Scripts used to plot results from above analyses for figure generation.

* `docs`: Files used for Cellranger and DRAGEN alignment and lists of neurological disorder genes.
