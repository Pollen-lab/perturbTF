...
ad <- subset(ad, ,supervised_name %in% c('EN','EN_ImN','IN','IPC_EN','IPC_IN','OPC-Oligo','RG-Astro','RG_DIV' ))
...
#logFC$Cell.Type <- factor(logFC$Cell.Type, levels =  c('RG_cycling','RG','IPC-EN','EN','RG_IN','IN','OPC'))
logFC$Cell.Type <- factor(logFC$Cell.Type, levels =  c('RG_DIV','RG-Astro','IPC_EN','EN_ImN','EN','IPC_IN','IN','IN_LQ','OPC-Oligo','MG','Technical'))
...
logFC <-  logFC %>% rstatix::add_significance(p.col = "LRT_pvals", 
  ...
  filter(Cell.Type %in% c('RG_DIV','RG-Astro','IPC_EN','EN_ImN','EN','IPC_IN','IN','OPC-Oligo'))
